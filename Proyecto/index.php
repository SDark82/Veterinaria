...
<head>
    ...
    <link rel="shortcut icon" href="static/img/Logo1.svg" type="image/x-icon">
    ...
    <main>
        <section class="contenedor sobre-nosotros">
            ...
            <div class="contenedor-sobre-nosotros">
                <img src="imgs/consulta.png" alt="" class="imagen-about-us">
            ...
            <div class="contenedor-sobre-nosotros">
              <img src="imgs/cirugia.png" alt="" class="imagen-about-us">
              <div class="contenido-textos">
          ...
          <div class="contenedor-sobre-nosotros">
            <img src="imgs/hospital.png" alt="" class="imagen-about-us">
            <div class="contenido-textos">
                ...
                <div class="galeria-port">
                    <div class="imagen-port">
                        ...
                        <div class="hover-galeria">
                            <img src="imgs/icono1.png" alt="">
                            <p>ir a Anuncio</p>
                        </div>
                    </div>
                    <div class="imagen-port">
                        <img src="imgs/poster2.png" alt="">
                        <div class="hover-galeria">
                            <img src="imgs/icono1.png" alt="">
                            <p>ir a Anuncio</p>
                        </div>
