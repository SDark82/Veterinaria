        ...
        <div class="main-user">
            ...
            <div class="contenedor">
                <div class="titulo-opcion">
                    <div class="motivo">FACTURAS</div>
                    <div class="atras" onclick="location.href = '../../secretaria/secretaria.php'">
                        ATRAS
                    </div>
                </div>
                <div class="botones">
                    <div class="boton verde" onclick="location.href = '../Facturas/s_agregarFactura.php'">
                        <div class="image">
                    ...
                    <div class="boton" id="editar" onclick="location.href = '../Facturas/s_editarFactura.php'">
                        <div class="image">
                        ...
                        <table id="tb-cliente" class="tabla">
                            ...
                            <tbody>
                                <tr class="filas" onclick="filas(event)">
                                    ...
                                    <td>BASE DE DATOS</td>
                                    <td>BASE DE DATOS</td>
                                    <td><button class="default-buton" onclick="location.href = '../Facturas/s_detalleFactura.php'">DETALLE</button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
