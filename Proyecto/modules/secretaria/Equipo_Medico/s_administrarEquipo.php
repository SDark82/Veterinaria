    ...
    <div class="fondo">
        ...
        <div class="main-user">
            ...
            <div class="contenedor">
                ...
                <div class="botones">
                    <div class="boton verde" onclick="location.href = '../Equipo_Medico/s_agregarEquipo.php'">
                        <div class="image">
                    ...
                    <div class="boton" id="editar" onclick="location.href = '../Equipo_Medico/s_modificarEquipo.php'">
                        <div class="image">
