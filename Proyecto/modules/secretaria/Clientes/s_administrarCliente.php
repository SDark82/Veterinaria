    ...
    <div class="fondo">
        ...
        <div class="main-user">
            ...
            <div class="contenedor">
                ...
                <div class="botones">
                    <div class="boton verde" onclick="location.href = '../Clientes/s_agregarCliente.php'">
                        <div class="image">
                    ...
                    <div class="boton" id="editar" onclick="location.href = '../Clientes/s_modificarCliente.php'">
                        <div class="image">
