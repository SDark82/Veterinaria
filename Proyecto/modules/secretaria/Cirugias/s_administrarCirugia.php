    ...
    <div class="fondo">
        ...
        <div class="main-user">
            ...
            <div class="contenedor">
                ...
                <div class="botones">
                    <div class="boton verde" onclick="location.href = '../Cirugias/s_agregarCirugia.php'">
                        <div class="image">
                    ...
                    <div class="boton" id="editar" onclick="location.href = '../Cirugias/s_editarCirugia.php'">
                        <div class="image">
        ...
        <div class="eliminar">
            <div class="mensaje color-blanco-transparente">
                ...
                <div class="eliminar-mensaje">
                    ¿ESTA SEGURO QUE DESEA DAR DE BAJA A <span id="nombreClienteEliminado"></span> ?
                </div>
