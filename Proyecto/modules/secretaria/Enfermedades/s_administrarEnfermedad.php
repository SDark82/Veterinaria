    ...
    <div class="fondo">
        ...
        <div class="main-user">
            ...
            <div class="contenedor">
                ...
                <div class="botones">
                    <div class="boton verde" onclick="location.href = '../Enfermedades/s_agregarEnfermedad.php'">
                        <div class="image">
                    ...
                    <div class="boton" id="editar" onclick="location.href = '../Enfermedades/s_modificarEnfermedad.php'">
                        <div class="image">
