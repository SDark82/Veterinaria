        ...
        <div class="main-user">
            ...
            <div class="contenedor">
                <div class="titulo-opcion">
                    <div class="motivo">MEDICAMENTO</div>
                    <div class="atras" onclick="location.href = '../../secretaria/secretaria.php'">
                        ATRAS
                    </div>
                </div>
                <div class="botones">
                    <div class="boton verde" onclick="location.href = '../Medicamentos/s_agregarMedicamento.php'">
                        <div class="image">
                    ...
                    <div class="boton" id="editar" onclick="location.href = '../Medicamentos/s_editarMedicamento.php'">
                        <div class="image">
