    ...
    <div class="fondo">
        ...
        <div class="main-user">
            ...
            <div class="contenedor">
                ...
                <div class="botones">
                    <div class="boton verde" onclick="location.href = '../admin_Cirugias/admin_agregarCirugia.php'">
                        <div class="image">
                    ...
                    <div class="boton" id="editar" onclick="location.href = '../admin_Cirugias/admin_editarCirugia.php'">
                        <div class="image">
