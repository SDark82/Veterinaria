...
<head>
    ...
    <title>Administra | Equipo Medico</title>
        ...
        <div class="main-user">
            ...
            <div class="contenedor">
                <div class="titulo-opcion">
                    <div class="motivo">AGREGAR EQUIPO MEDICO</div>
                    <div class="atras" onclick="location.href = '../admin_Equipo/admin_Equipo.php'">
                        ATRAS
                    </div>
                </div>
                <div class="botones">
                    ...
                    <div class="forma">
                        <div class="personal">
                            ...
                            <div class="info-personal">
                                <div class="col">
                                    <div class="params">ID EQUIPO MEDICO
                                    </div>
