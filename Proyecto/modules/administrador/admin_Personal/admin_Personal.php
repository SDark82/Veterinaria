        ...
        <div class="main-user">
            ...
            <div class="contenedor">
                <div class="titulo-opcion">
                    <div class="motivo">PERSONAL</div>
                    <div class="atras" onclick="location.href = '../../administrador/administrador.php'">
                        ATRAS
                    </div>
                </div>
                <div class="botones">
                    <div class="boton verde" onclick="location.href = '../admin_Personal/admin_agregarPersonal.php'">
                        <div class="image">
                    ...
                    <div class="boton" id="editar" onclick="location.href = '../admin_Personal/admin_editarPersonal.php'">
                        <div class="image">
