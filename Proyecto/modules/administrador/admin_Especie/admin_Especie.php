...
<head>
    ...
    <title>Administrador | Especie</title>
    ...
    <div class="fondo">
        ...
        <div class="main-user">
            ...
            <div class="contenedor">
                ...
                <div class="botones">
                    <div class="boton verde" onclick="location.href = '../admin_Especie/admin_agregarEspecie.php'">
                        <div class="image">
                    ...
                    <div class="boton" id="editar" onclick="location.href = '../admin_Especie/admin_editarEspecie.php'">
                        <div class="image">
