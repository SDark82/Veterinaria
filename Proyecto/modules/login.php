  ...
  <div class="main">
    ...
    <div class="login">
      ...
      <div class="text-box">
        ...
        <input type="text" class="cuadro-texto" placeholder="Usuario" spellcheck="false" id="user" pattern='[A-Za-z0-9-_]{1,15}' />
      </div>
      <div class="text-box">
        <div class="icon">
          <i class="fas fa-lock" style="color: white;"></i>
        </div>
          <input type="password" class="cuadro-texto" spellcheck="false" placeholder="Clave" id="password" pattern='[A-Za-z0-9-_]{1,15}'/>
      </div>
