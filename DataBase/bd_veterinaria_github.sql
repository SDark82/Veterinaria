...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-08-2021 a las 08:14:32
...
--
-- Base de datos: `bd_veterinaria_github`
--
...
CREATE TABLE `cirugia` (
  `id_cirugia` varchar(10) NOT NULL,
  `motivo` text DEFAULT NULL,
  `descripcion` varchar(250) NOT NULL,
  `precio` float NOT NULL,
  `id_paciente` varchar(10) NOT NULL,
  `id_personal` varchar(10) DEFAULT NULL,
  `id_cita` varchar(10) DEFAULT NULL,
  `baja` binary(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `hospitalzacion` (
  `id_hospita` varchar(10) NOT NULL,
  `fecha` date NOT NULL,
  `hora` time NOT NULL,
  `motivo` text DEFAULT NULL,
  `costo_dia` double NOT NULL,
  `id_jaula` varchar(10) DEFAULT NULL,
  `id_paciente` varchar(10) NOT NULL,
  `id_personal` varchar(10) DEFAULT NULL,
  `id_medicamento` varchar(10) DEFAULT NULL,
